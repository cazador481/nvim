...
syn keyword mysqlKeyword         begin both by
syn keyword mysqlKeyword         call cascade change character check checksum column columns comment constraint create cross
syn keyword mysqlKeyword         commit current_date current_time current_timestamp
syn keyword mysqlKeyword         data database databases day day_hour day_minute day_second
syn keyword mysqlKeyword         default delayed delay_key_write delete delimiter desc describe distinct distinctrow drop
...
syn keyword mysqlKeyword         identified if ignore index infile inner insert insert_id into isam
